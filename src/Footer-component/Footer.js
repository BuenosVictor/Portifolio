...
export function Footer() {
  return (
    <footer id="Footer" className="bg-secondaryL text-white h-[60vh] grid grid-cols-2 grid-rows-[10%_90%] place-items-center relative px-4 sm:px-6 lg:px-20">
      {/* Call to action */}
      <div className="bg-primaryL rounded-2xl p-4 sm:p-6 row-span-1 col-span-2 -top-[10%] absolute w-full max-w-3xl mx-auto">
      ...
      {/* Contact links */}
      <div className="row-start-2 row-end-3 col-start-1 col-end-3 lg:col-end-2 w-full place-items-center md:place-content-stretch max-w-md">
        ...
        <ol className="flex flex-col space-y-2 sm:space-y-3">
          {[
            ...
            <li key={index}>
              <a
                className="flex items-center p-2 sm:p-3 hover:bg-detail rounded-lg transition-transform duration-200 transform hover:scale-105 text-xs sm:text-sm"
                href={url}
                target="_blank"
